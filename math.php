...
<main>
    ...
    <section class="department-hero math-bg">
        <div class="container">
            <h1><i class="fas fa-square-root-alt"></i> Département de Mathématiques</h1>
            <p>Excellence en analyse, algèbre et mathématiques appliquées</p>
        </div>
    </section>
