...
<main>
    <section class="department-hero chemistry-bg">
        <div class="container">
            <h1><i class="fas fa-flask"></i> Département de Chimie</h1>
            <p>Formation en chimie organique, analytique et science des matériaux</p>
        </div>
    </section>
